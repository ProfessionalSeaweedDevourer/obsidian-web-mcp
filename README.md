...
| `vault_edit` | Patch a file with ordered edits: exact or whitespace-normalized text replacements, or anchor inserts (`insert_after`/`insert_before`) for adding or moving blocks without resending their body; supports dry-run diff previews |
